...
export const products: Product[] = [
  {
    slug: 'montaj-grubu-parcalar',
    name: {
      tr: 'Montaj Grubu Parçalar',
      en: 'Sub-Assembly Parts',
      de: 'Baugruppenteile',
      ar: 'قطع مجموعات التجميع',
    },
    image: '/images/categories/parcalar_13.jpg',
    description: {
      tr: 'Talaşlı imalat parçaları ve montaj grupları. 5 eksen CNC işleme merkezlerinde havacılık hassasiyetinde üretim, montaj kabiliyeti ile komple çözüm.',
      en: 'Machined parts and sub-assemblies. Precision manufacturing on 5-axis CNC machining centers with full assembly capability.',
      de: 'Zerspanungsteile und Baugruppen. Präzisionsfertigung auf 5-Achs-CNC-Bearbeitungszentren mit vollständiger Montagekompetenz.',
      ar: 'قطع مشغولة بالآلات ومجموعات تجميع فرعية. تصنيع دقيق على مراكز تشغيل CNC خماسية المحاور مع قدرة تجميع متكاملة.',
    },
    details: {
      tr: [
